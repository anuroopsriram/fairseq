...
base_params = {
    ...
    # 'conv-feature-layers': [(512, 3, 2)] + [(512, 3, 1)] * 4 + [(512, 3, 1)] * 2,
...
if __name__ == '__main__':
    ...
    name = base_args.name
    # lrs = [0.000001, 0.000003, 0.00003, 0.0001, 0.0003, 0.001]
    # lrs = [0.00003, 0.0001, 0.0003, 0.001]
    # clipnorms = [0.01, 0.1, 1, 10]
    lrs = [0.0005]
    clipnorms = [0]
    for lr in lrs:
    ...
    # submit.main(base_args, base_params, 'unlab')
