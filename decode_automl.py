...
def get_args():
    ...
    parser.add_argument("--remove-bpe", "--post-process", type=str, default=None, help="bpe symbol")
...
def launch_local(hyperparams):
    ...
    infer_args.batch_size = None
    infer_args.data_buffer_size = 10
    infer_args.post_process = hyperparams['remove_bpe'] if 'remove_bpe' in hyperparams else None
