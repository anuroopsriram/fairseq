...
def sweep_w2v_base(base_args):
    checkpoints = {
        "w2v.base.8x400.mlp.ft": Path("logs/w2v.base.8x400.mlp/lr0.0005.contextmlpTrue.tgtmlpTrue.bnTrue.actrelu.scale4.unlab/"),
        # "w2v.tracking.8x400.mlp.ft": Path("logs/w2v.tracking.8x400.mlp/lr0.0005.contextmlpTrue.tgtmlpTrue.tau0.995.unlab/"),
    }
...
#
#         Path("logs/w2v.tracking.4x400.mlp/lr0.0005.contextmlpTrue.tgtmlpTrue.tau0.95.unlab"),
#         Path("logs/w2v.tracking.4x400.mlp/lr0.0005.contextmlpTrue.tgtmlpTrue.tau0.99.unlab"),
#         Path("logs/w2v.tracking.4x400.mlp/lr0.0005.contextmlpTrue.tgtmlpTrue.tau0.995.unlab"),
#     ]
#     # mask_lens = [6, 10, 14]
...
#
#     base_args.name = base_args.name or 'w2v.tracking.400k.ft'
#     submit.run_sweeps(w2v_base_4x400k, base_args, base_params, param_sweeps, dataset='lab.10h')
#
#
# @submit.register_sweep
