...
def automl(args):
    ...
    if args.local:
        ...
        cmd += f" > {args.model}/automl_{args.lm}/{split}.auto_ml/OUT &"

    Path(f"{args.model}/automl_{args.lm}/{split}.auto_ml").mkdir(exist_ok=True, parents=True)
...
def infer(args):
    ...
    cmd = (
        ...
        f"--seed {args.seed} --task audio_pretraining --w2l-decoder {args.lm} --lm-model {lmpath} "
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data", default="/checkpoint/anuroops/data/libris/lab.960h")
