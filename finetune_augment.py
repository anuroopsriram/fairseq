...
wer_args = (
    '/checkpoint/abaevski/data/speech/libri/4-gram.bin',
...
# def sweep_w2v_aug_mlp(base_args):
#     checkpoints = [
#         # Path("logs/w2v.base.8x400k.augment/lr0.0005.sourceaug1.targetaug1.augsadditive,speed.ld0.0.snr_min8.speed_std0.1.unlab"),
#         # Path("logs/w2v.base.8x400k.augment.mlp/lr0.0002.sourceaug1.targetaug1.augsadditive.ld0.0.snr_min5.contextmlpTrue.tgtmlpTrue.bnTrue.actrelu.scale4.unlab"),
#         # Path("logs/w2v.base.8x400k.augment.mlp/lr0.0002.sourceaug1.targetaug1.augsadditive,speed.ld0.0.snr_min10.speed_std0.1.contextmlpTrue.tgtmlpTrue.bnTrue.actrelu.scale4.unlab"),
#         # Path("logs/w2v.base.8x400k.augment.mlp/lr0.0002.sourceaug1.targetaug1.augsadditive,speed.ld0.0.snr_min8.speed_std0.1.contextmlpTrue.tgtmlpTrue.bnTrue.actrelu.scale4.unlab"),
#         # Path("logs/w2v.base.8x400k.augment.mlp/lr0.0002.sourceaug1.targetaug1.augsspeed.ld0.0.speed_std0.1.contextmlpTrue.tgtmlpTrue.bnTrue.actrelu.scale4.unlab"),
#         # Path("logs/w2v.base.8x400k.augment.mlp/lr0.0005.sourceaug1.targetaug1.augsadditive,speed.ld0.0.snr_min8.speed_std0.1.contextmlpTrue.tgtmlpTrue.bnTrue.actrelu.scale4.unlab"),
#
#         # Path("logs/w2v.base.8x400k.augment.mlp/lr0.0005.sourceaug1.targetaug1.augsadditive,speed.ld0.0.snr_min8.speed_std0.1.contextmlpTrue.tgtmlpFalse.bnFalse.actrelu.scale4.unlab"),
#         # Path("logs/w2v.base.8x400k.augment.mlp/lr0.0005.sourceaug1.targetaug1.augsadditive,speed.ld0.0.snr_min8.speed_std0.1.contextmlpFalse.tgtmlpTrue.bnFalse.actrelu.scale4.unlab"),
#         # Path("logs/w2v.base.8x400k.augment.mlp/lr0.0005.sourceaug1.targetaug1.augsadditive,speed.ld0.0.snr_min8.speed_std0.1.contextmlpFalse.tgtmlpTrue.bnTrue.actrelu.scale4.unlab"),
#     ]
#     lrs = [
#         1e-05,
#         2e-05,
...
#         # args.nodes = 1
#         args.name = "w2v.base.8x400k.augment.mlp.ft.run2"
#         param_sweeps = [
#             (
#                 f"ckpt{checkpoint.name}.lr{lr}.mlen{mlen}.mprob{mprob}.upds{max_update}",
#                 {
#                     "lr": lr,
#                     'mask-length': mlen,
#                     'mask-prob': mprob,
...
@submit.register_sweep
def sweep_w2v_base_libris(base_args):
    checkpoints = [
    ...
    for checkpoint in checkpoints:
        for dset, max_update in datasets:
            args = deepcopy(base_args)
            args.name = "w2v.base.8x400k.augment.ft.libris.run3"
            param_sweeps = [
                (
                    f"ckpt{checkpoint.name}.lr{lr}.mlen{mlen}.mprob{mprob}.dodefault.kenlm",
                    {
                        "lr": lr,
                        'mask-length': mlen,
                        'mask-prob': mprob,
            ...
            submit.run_sweeps(w2v_base, args, base_params, param_sweeps, dataset=dset)
