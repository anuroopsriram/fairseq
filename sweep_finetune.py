...
def get_grid(args):
    ...
    return [
        ...
        hp("--warmup-steps", int(config.LAB_DATASETS[args.dataset]["steps"] * .2), save_dir_key=lambda val: f"wstep{val}"),
        hp("--hold-steps", int(config.LAB_DATASETS[args.dataset]["steps"] * .3), save_dir_key=lambda val: f"hstep{val}"),
        hp("--decay-steps", int(config.LAB_DATASETS[args.dataset]["steps"] * .5), save_dir_key=lambda val: f"dstep{val}"),
